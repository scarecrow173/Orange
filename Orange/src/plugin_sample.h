...
namespace Orange
{
	namespace Plugin
	{
		...
		static const int										ORANGE_SAMPLE_PLUGIN_CONTROLLER_SAMPLEFREQ_TAG = 100;
		static const int										ORANGE_SAMPLE_PLUGIN_CONTROLLER_FREQ_TAG = 101;
		...
		public:
			...
			Steinberg::Vst::ParamValue sampleFreq = 1.0;
			Steinberg::Vst::ParamValue freq = 1.0;
		private:
